...
### Kernaussage
Der Kapitalbedarf einer Ferienimmobilie besteht nicht nur aus dem Kaufpreis. Zusätzlich zu berücksichtigen sind Erwerbsnebenkosten, Umsatzsteuer-Liquidität, Finanzierungskosten, Einrichtung, Renovierung, Anfangsreserve und laufende Rücklagen.

### Geltungsbereich
- Land: Österreich
- Finanzierung: Immobilienkauf, Hypothekarkredit, Eigenkapital, Fremdkapital
- Keine konkrete Kreditberatung
...
### Allgemeine Kapitalbedarfsformel
```text
Gesamtbedarf =
Kaufpreis
+ allfällige Umsatzsteuer
+ Grunderwerbsteuer
+ Grundbuchgebühr
+ Pfandrechtseintragung
+ Vertragserrichtung / Treuhand / Notar / Rechtsanwalt
+ Maklerprovision
+ Bankspesen
+ Einrichtung / Inventar
+ Renovierung / technische Anpassungen
+ Anfangsreserve
+ laufende Betriebsmittelreserve
```

### Offene Prüfpunkte
- Brutto- oder Nettokaufpreis?
- Umsatzsteuerpflichtiger Kauf?
- Darlehenshöhe?
- Pfandrecht?
- Renovierungsbedarf?
- Ausstattung?
- Reserve für Leerstand und Reparaturen?

## 2. Eigenkapital

### Kernaussage
Eigenkapital reduziert Finanzierungsrisiko, Bankrisiko und laufenden Kapitaldienst. Bei mehreren Beteiligten muss geregelt werden, ob alle gleich viel einlegen oder unterschiedliche Kapitalanteile erhalten.

### Geltungsbereich
- Land: Österreich
- Beteiligte: natürliche Personen oder Gesellschaften
...
### Offene Prüfpunkte
- gleiche oder ungleiche Einlagen?
- Kapitalkonten?
- Nachschusspflichten?
- Reservekonto?
- Eigenkapitalnachweis gegenüber Bank?
- private Darlehen einzelner Beteiligter?
- Verzinsung von Gesellschafterdarlehen?

## 3. Fremdfinanzierung

### Kernaussage
Fremdfinanzierung erfolgt häufig über einen hypothekarisch besicherten Kredit. Relevante Parameter sind Darlehenshöhe, Zinssatz, Zinsbindung, Laufzeit, Tilgung, Sondertilgung, Sicherheiten und persönliche Haftung.

### Geltungsbereich
- Land: Österreich
- Finanzierungsart: Immobilienkredit
...
- Covenant / Mindestreserve?
- Zinsänderungsrisiko?

## 4. Kreditnehmerstruktur

### Kernaussage
Die Wahl des Kreditnehmers ist eine zentrale Strukturfrage. Kreditnehmer können natürliche Personen, Miteigentümer, eine Personengesellschaft oder eine Kapitalgesellschaft sein. Banken verlangen häufig zusätzliche Sicherheiten oder persönliche Haftungen.

### Geltungsbereich
- Land: Österreich
- Beteiligte: mehrere Eigentümer oder Gesellschaft
- Finanzierung: Bankkredit, Sicherheiten, Bürgschaften
...
| Kreditnehmer | Vorteile | Nachteile / Risiken |
|---|---|---|
| alle Miteigentümer persönlich | Bonität aller nutzbar, einfache Besicherung | gesamtschuldnerische Haftung, Konflikte bei Ausstieg |
| GesbR / Miteigentümerstruktur | vertraglich flexibel | keine eigene Grundbuchfähigkeit der GesbR, persönliche Haftung |
| KG | klare Gesellschaftsstruktur | Komplementärhaftung, Bank verlangt ggf. Sicherheiten |
| GmbH | einheitlicher Kreditnehmer, professionelle Außenwirkung | neue GmbH ohne Historie oft schwach; Bürgschaften wahrscheinlich |
| GmbH & Co KG | strukturierbar für Investoren | komplexer, höhere Kosten, bankseitig erklärungsbedürftig |
...
### Prüfkriterien
- Eigenkapitalquote
- Haushaltsrechnung / Bonität der Beteiligten
- Objektwert und Beleihungswert
- Grundbuchrang
...
## 6. Finanzierung bei Vermietung

### Kernaussage
Bei geplanter Vermietung sollte die Finanzierung mit konservativen Auslastungs-, Preis- und Kostenannahmen gerechnet werden. Eigennutzung reduziert potenziell vermietbare Tage und kann die steuerliche Behandlung beeinflussen.
...
### Szenarien
- konservatives Auslastungsszenario
- Basisszenario
- optimistisches Szenario
- Zinserhöhungsszenario
- Renovierungs-/Reparaturszenario
- Leerstandsszenario
- Ausfall einzelner Eigentümer

## 7. Finanzierungsunterlagen

### Kernaussage
Für Bankgespräche sollten rechtliche, wirtschaftliche, steuerliche und organisatorische Unterlagen konsistent aufbereitet werden.
...
- Nachweis touristische Vermietbarkeit / Freizeitwohnsitzstatus
- Fotos und Gutachten
- Eigenkapitalnachweise
- Bonitätsunterlagen der Beteiligten
- Gesellschaftsvertrag / Miteigentümervereinbarung
- Nutzungsordnung
...
- Dürfen Anteile verkauft werden?
- Wie wird die Bank eingebunden?
- Wie werden steigende Zinsen verteilt?
